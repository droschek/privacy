...
### Polski
Ta aplikacja nie przechowuje, nie gromadzi ani nie przetwarza żadnych danych osobowych. 
Wszystkie wprowadzone informacje są zapisywane wyłącznie lokalnie na urządzeniu i nie są przekazywane osobom trzecim. 
Nie nawiązuje się połączenia z serwerami zewnętrznymi, nie przeprowadza się analizy ani oceny zachowań użytkowników. 
Korzystanie z aplikacji jest całkowicie anonimowe i nie wymaga rejestracji ani logowania.
